...
var maplemap = {
	...
	setMarkerCss: function(countn,rating) {
		color = "hsl(" + maplemap.getRating2Scale(rating) +  ", 100%, 50%)";
		var markercontent = "<i class='common_bg icon_map_mark4' style='background-color:" + color + ";'><span>" + countn + "</span></i>";
	...
	setContent: function(map,lat, lng, count, htmlinfo,rating) {
		...
		var content = maplemap.setMarkerCss(count,rating);
